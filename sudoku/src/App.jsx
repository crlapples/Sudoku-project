...
const App = () => {
  ...
  return (
    <div className="appContainer">
      <p className="disclaimer">Disclaimer: It may become unresponsive(give it time) or slow as it's calculating a lot of possibilities. I can't store premade puzzles, so this is the most I could do.</p>
